...
show_check = tk.Checkbutton(frame, text="Show Password", variable=show_password,
                            command=toggle_password_visibility, bg="lightblue")
show_check.grid(row=0, column=2, padx=5, pady=5)
...
output_text = tk.Text(frame, height=10, width=75, state='disabled', font=("Arial", 10))
...
strength_meter = ttk.Progressbar(frame, orient=tk.HORIZONTAL, length=500, mode='determinate',
                                 style="Blue.Horizontal.TProgressbar", value=0)
